        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                Rectangle {
                    ...
                    color: sensorBridge.haConnected ? "#1F3A2B" : "#3D1F1F"
                    Text {
                        anchors.centerIn: parent
                ...
                ColumnLayout {
                    Text {
                        ...
                        font.pixelSize: 15
                        font.weight: Font.Bold
                        color: sensorBridge.haConnected ? "#10B981" : "#EF4444"
                    }
                    Text {
            ...
            ColumnLayout {
                ...
                RowLayout {
                    Layout.fillWidth: true
                    Text { text: qsTr("Network Latency:"); font.pixelSize: 13; color: "#94A3B8"; Layout.fillWidth: true }
                    Text {
                ...
                RowLayout {
                    ...
                    Text { text: qsTr("Reconnect Attempts:"); font.pixelSize: 13; color: "#94A3B8"; Layout.fillWidth: true }
                    Text {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        Layout.fillWidth: true
                        Text { text: qsTr("Next Reconnect in:"); font.pixelSize: 13; color: "#94A3B8"; Layout.fillWidth: true }
                        Text {
                            text: (popup.remainingMs / 1000.0).toFixed(1) + " s"
                            font.pixelSize: 13; font.weight: Font.Bold; color: "#3B82F6"
                        }
                    }
                    ProgressBar {
                        Layout.fillWidth: true
                        ...
                        background: Rectangle { implicitHeight: 6; color: "#1F293D"; radius: 3 }
                        contentItem: Item {
                            Rectangle {
                                width: parent.width
                ...
                ColumnLayout {
                    Layout.fillWidth: true
                    spacing: 2
                    Text { text: qsTr("Last Disconnect Reason:"); font.pixelSize: 12; color: "#94A3B8" }
                    Text {
                        text: sensorBridge.haLastDisconnectReason
                        font.pixelSize: 12; font.weight: Font.Medium; color: "#EF4444"
            ...
            Button {
                ...
                background: Rectangle {
                    color: parent.pressed ? "#1E2640" : "#151B2E"
                    border.color: "#3B82F6"
                    border.width: 1
                    radius: 8
                }
